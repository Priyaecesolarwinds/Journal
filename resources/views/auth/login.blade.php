                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                        <div class="authentication-form mx-auto">
                            <div class="logo-centered">
                               <!-- <a href="#"><img height="40" src="{{ asset('img/logo1.png') }}" alt="ADMIN" ></a>-->
                            </div>
                            <p>Welcome back! </p>
                            ...
                            @csrf
                               ...
                               <!-- <div class="row">
                                    ...
                                    <div class="col text-right">
                                        <a class="btn text-danger" href="{{url('password/forget1')}}">
                                            {{ __('Forgot Password?') }}
                                        </a>
                                    </div>
                                </div>-->
                                ...
                                <!-- <div class="register">
                                    <p>{{ __('No account?')}} <a href="{{url('register1')}}">{{ __('Sign Up')}}</a></p>
                                </div>-->
