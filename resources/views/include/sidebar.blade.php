<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
           <!-- <div class="logo-img">
               <img height="30" src="{{ asset('img/logo_white1.png')}}" class="header-brand-img" title="ADMIN"> 
            </div>-->
        </a>
            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ ($segment1 == 'users' || $segment1 == 'roles'||$segment1 == 'permission' ||$segment1 == 'user') ? 'active open' : '' }} has-sub">
                    ...
                    <div class="submenu-content">
                        ...
                        @can('manage_user')
						<a href="uploadPayslip" class="menu-item {{ ($segment1 == 'uploadPayslip') ? 'active' : '' }}">Upload Payslip</a>
                        <a href="taxDeclaration" class="menu-item {{ ($segment1 == 'taxDeclaration') ? 'active' : '' }}">Tax Declaration</a>
                ...
                <div class="nav-item {{ ($segment1 == 'table-datatable-edit') ? 'active' : '' }}">
                    <a href="pre"><i class="ik ik-layout"></i><span>{{ __('My Page')}}</span>  </a>
                </div>
