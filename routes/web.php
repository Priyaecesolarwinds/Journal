...
Route::get('/pre',[ PreController::class,'showMyPage']);
Route::get('/student',[ StudentController::class,'showStudents']);
Route::get('/uploadPayslip', [PaySlipController::class,'showForm']);   //mani
Route::post('/payslip/create', [PaySlipController::class,'store'])->name('create-payslip');
Route::get('/taxDeclaration', [TaxDeclarationController::class,'index']);
Route::get('/taxDeclaration/get-list', [TaxDeclarationController::class,'getTaxDeclarationList']);
